...
let ONCard = $.getdata('youthzqcard') || "false"; //早起打卡开关
let s = $.getdata('delay_rotary_zq') || "10"; //转盘延迟时间
let withdrawcash = $.getdata('youthzqcash') || 30; //提现金额
let cardTime = $.getdata('youthzqtime') || "05"; //打卡时间

// 需获取部分
let withdrawUrl = $.getdata('youthcashurl_zq'); //提现地址，可选
let withdrawBody = $.getdata('youthcashbody_zq'); //提现请求，可选
let cookieYouth = $.getdata('youthhd_zq');
let artBody = $.getdata('youthread_zq');
let readTimes = $.getdata('youthreadtime_zq');
